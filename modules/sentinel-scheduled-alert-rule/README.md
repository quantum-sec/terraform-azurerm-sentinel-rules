...
| <a name="input_severity"></a> [severity](#input\_severity) | The severity of the alert generated by this rule. One of `High`, `Medium`, `Low`, or `Informational`. | `string` | `"Low"` | no |
